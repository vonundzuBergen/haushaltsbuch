...
var InfoBoxService = (function () {
    function InfoBoxService() {
        this._showError = new Subject_1.Subject();
        this.showError$ = this._showError.asObservable();
    }
    InfoBoxService.prototype.showInfoBox = function (show) {
        this._showError.next(show);
    };
    return InfoBoxService;
}());
InfoBoxService = __decorate([
    core_1.Injectable(),
    __metadata("design:paramtypes", [])
], InfoBoxService);
exports.InfoBoxService = InfoBoxService;
//# sourceMappingURL=info-box.service.js.map