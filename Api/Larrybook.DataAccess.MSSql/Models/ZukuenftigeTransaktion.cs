...
{
    /// <summary>
    /// Represents a ZukuenftigeTransaktion Entity as it is stored in the database.
    /// </summary>
    [Table("WiederkehrendeTransaktion")]
    public class ZukuenftigeTransaktion
    {
        [Key, DatabaseGenerated(DatabaseGeneratedOption.Identity)]
        [Column("WiederkehrendeTransaktionId", Order = 0, TypeName = "int")]
        public int ZukuenftigeTransaktionId { get; set; }
